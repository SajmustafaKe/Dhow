...
import type { PricesResponse, SubscriptionPlan } from "@/app/lib/types/billing_types";
import { z } from "zod";
...
export function BillingUpgradeModal({ isOpen, onClose, errorMessage }: BillingUpgradeModalProps) {
    ...
    const modalTitle = currentPlan === 'pro'
        ? "You've reached your plan limits"
        : "Upgrade to do more with Dhow";
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
            <DialogContent className="sm:max-w-2xl bg-white dark:bg-gray-900">
                ...
                <DialogFooter className="border-t border-gray-200 dark:border-gray-800 pt-4 sm:justify-start">
                    <Link
                        href="/billing"
