...
// Ported from apps/dhow/components/ui/button.tsx.
// NOT the shadcn Button at components/ui/button.tsx — this is dhow's own
// pill-shaped Button with a distinct variant/size vocabulary and hover-swap
// content support that shadcn's Button does not have. Renamed to avoid the
// filename collision; see the port report for callers that need this one
// instead of the standard shadcn Button.
...
export const Button = forwardRef<HTMLButtonElement, PillButtonProps>(({
  className,
  variant = 'primary',
  size = 'md',
  startContent,
