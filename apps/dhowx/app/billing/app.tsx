                                ...
                                <Badge
                                    ...
                                    className={clsx(
                                        ...
                                        customer.subscriptionStatus === "active"
                                            ? "border-green-300 bg-green-50 text-green-700 dark:bg-green-900 dark:text-green-200 dark:border-green-700"
                                            : "border-red-300 bg-red-50 text-red-700 dark:bg-red-900 dark:text-red-200 dark:border-red-700"
                                    )}
                                >
                                    {displayStatus}
                                </Badge>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <Progress
                            ...
                            className={clsx(
                                "h-4",
                                usage.availableCredits < 0 && "[&>[data-slot=progress-indicator]]:bg-destructive"
                            )}
