  ...
  return (
    <>
              ...
              navItems.map((item) => {
                ...
                return <>
                  ...
                  >
                    ...
                    <TooltipContent side="right">{collapsed ? item.label : ""}</TooltipContent>
                  </Tooltip>}
                  {!collapsed && <Link
                    href={fullPath}
                    className={`
        ...
        <div className="mt-auto">
          ...
          <div className="p-3 border-t border-zinc-100 dark:border-zinc-800 space-y-2">
            ...
            <Tooltip>
              ...
              <TooltipContent side="right">{collapsed ? "Help" : ""}</TooltipContent>
            </Tooltip>
            ...
            {SHOW_DARK_MODE_TOGGLE && (
              <Tooltip>
                ...
                <TooltipContent side="right">{collapsed ? "Appearance" : ""}</TooltipContent>
              </Tooltip>
            )}
      ...
      <Dialog
        ...
        onOpenChange={(open) => { if (!open) handleCreateModalClose(); }}
      >
