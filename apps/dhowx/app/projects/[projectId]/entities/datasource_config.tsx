...
import { z } from "zod";
import { XIcon, FileIcon, GlobeIcon, AlertTriangle, CheckCircle, Circle, ExternalLinkIcon, PlusIcon, DownloadIcon, Trash2, Loader2 } from "lucide-react";
                                ...
                                >
                                    ...
                                    <div className="flex gap-2">
                                        <Button
                                            ...
                                            disabled={addingUrls}
                                        >
                                            {addingUrls && <Loader2 className="w-4 h-4 animate-spin" />}
                                            {!addingUrls && <PlusIcon className="w-4 h-4" />}
