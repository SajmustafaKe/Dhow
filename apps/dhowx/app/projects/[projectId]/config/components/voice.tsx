    ...
    return (
        ...
        >
            <div className="space-y-2">
                <div className="border rounded-lg focus-within:ring-2 border-gray-200 dark:border-gray-700 focus-within:ring-indigo-500/20 dark:focus-within:ring-indigo-400/20">
                    <Textarea
                        value={value}
