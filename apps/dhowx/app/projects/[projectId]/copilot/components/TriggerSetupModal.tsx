      ...
      >
        <DialogContent className="sm:max-w-5xl max-h-[90vh] flex flex-col">
          <DialogHeader className="flex flex-col gap-1">
            <DialogTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">Set up External Trigger</DialogTitle>
          ...
          <div className="flex-1 overflow-y-auto pb-6">
            ...
            {selectedToolkit && selectedTriggerType && (!requiresAuth || hasActiveConnection) && (
              <div className="space-y-4">
                <div>
                  <Button variant="ghost" size="sm" onClick={() => setSelectedTriggerType(null)}>
                    Back
                  </Button>
                </div>
                <TriggerConfigForm
