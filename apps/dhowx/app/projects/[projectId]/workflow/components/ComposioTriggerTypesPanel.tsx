...
import { ChevronRight, ZapIcon, ArrowLeft } from 'lucide-react';
import { z } from 'zod';
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12">
          ...
          <Button variant="secondary" onClick={() => loadTriggerTypes(true)}>
            Try Again
          </Button>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
            {triggerTypes.map((triggerType) => (
              <Card
                ...
                role="button"
                tabIndex={0}
                onClick={() => handleTriggerTypeSelect(triggerType)}
                onKeyDown={(e) => {
          ...
          {hasNextPage && (
            <div className="flex justify-center pt-4">
              ...
              >
                {loadingMore ? <Spinner size="sm" /> : <ChevronRight className="w-4 h-4" />}
