...
const copilotPrompts = {
    ...
    "Meeting prep workflow": {
        prompt: "Create a workflow that prepares meeting briefs by researching attendees and their companies",
        emoji: "📅"
    },
    "Scheduling assistant": {
        prompt: "Build an assistant that can schedule meetings by checking calendar availability and sending invites",
        emoji: "🗓️"
    },
    "Reddit & HN assistant": {
        prompt: "Create an assistant that monitors Reddit and Hacker News for relevant discussions and summarizes them",
        emoji: "💬"
    }
};
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="text-center mb-16">
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-6 leading-tight">
                            Build <span className="bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent">Dhows</span> that Work for You
                        </h1>
                    </div>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="p-6 pb-0">
                            <Tabs defaultValue="new" value={selectedTab} onValueChange={(value) => {
                                setSelectedTab(value);
                            }} className="w-full">
                                <TabsList>
                                    <TabsTrigger value="new">New Assistant</TabsTrigger>
                                    <TabsTrigger value="existing">My Assistants</TabsTrigger>
                                </TabsList>
