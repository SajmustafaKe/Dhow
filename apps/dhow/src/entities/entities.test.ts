...
describe("User", () => {
    ...
    it("rejects a non-ISO createdAt", () => {
        const r = User.safeParse({ id: "u1", authId: "a1", createdAt: "not-a-date" });
...
describe("required-field completeness (isolates each field, not just parse({}))", () => {
    it("User", () => {
        expectRequiredKeys(User, { id: "u1", authId: "a1", createdAt: iso() }, ["id", "authId", "createdAt"]);
    });
