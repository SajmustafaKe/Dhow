...
export const composioTools: z.infer<typeof BuiltinToolsSchema> = {
    ...
    'composio-execute-tool': {
        ...
        description: 'Execute a Composio tool by its slug. You MUST pass the arguments field with all required parameters from the search results inputSchema. Example: composio-execute-tool({ toolSlug: "GITHUB_ISSUES_LIST_FOR_REPO", toolkitSlug: "github", arguments: { owner: "SajmustafaKe", repo: "Dhow", state: "open", per_page: 100 } })',
        inputSchema: z.object({
