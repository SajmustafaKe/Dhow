  ...
  return (
    <div className="flex flex-col flex-1">
      ...
      <p className="text-base text-muted-foreground text-center leading-relaxed mb-8">
        Dhow gets smarter the more it knows about your work. Connect your accounts to get started. You can find more tools in Settings.
      </p>
          ...
          {(useComposioForGoogle || useComposioForGoogleCalendar || providers.includes('google')) && (
            <div className="space-y-3">
              ...
              {useComposioForGoogle ? (
                ...
                <ProviderCard
                  name="Google"
                  description="Dhow uses your email and calendar to provide personalized, context-aware assistance"
                  icon={<GmailIcon />}
                  iconBg="bg-red-500/10"
                  iconColor="text-red-500"
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="text-sm font-semibold">Dhow Meeting Notes</div>
