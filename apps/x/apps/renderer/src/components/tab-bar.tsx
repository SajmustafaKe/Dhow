...
export function TabBar<T>({
  ...
  return (
    <div
      className={cn(
        'dhow-tabbar flex flex-1 self-stretch min-w-0',
        layout === 'scroll'
        ...
        return (
          <React.Fragment key={tabId}>
            ...
            <button
              ...
              className={cn(
                'dhow-tab titlebar-no-drag group/tab relative flex items-center gap-1.5 px-3 self-stretch text-xs transition-colors',
