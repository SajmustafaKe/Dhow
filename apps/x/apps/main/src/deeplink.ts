...
export const DEEP_LINK_SCHEME = "dhow";
...
/**
 * Dispatch any dhow:// URL — chooses between action and navigation
 * automatically. Use this from notification click handlers and other URL
 * entry points.
 */
